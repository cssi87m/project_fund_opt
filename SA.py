...
# '''print all errors in 1 file'''
# import sys 
# sys.stderr = open('error.log', 'w') 
# from CONSTANT import import_data
class Cycle:
...
class state: 
    ...
    def calc_obj(self):
        ...
        # time_done = self.state[-1].time_done
...
def e_power(obj1, obj2, temperature):
    return math.exp(((obj1[0] - obj2[0]) - 0.5*(obj1[1] - obj2[1]) - 0.001*(obj1[2] - obj2[2]))/temperature)
    ...
    def solve(self):
        ...
        for _ in range(self.num_iterations):
            ...
            if self.visited.get(cand_state, 1) == 1:
                # construct neighborhood of best_cand
                best_cand.swap()
...
def main(): 
    ...
    # tasks, teams, task_team, graph = import_data("input.txt")
